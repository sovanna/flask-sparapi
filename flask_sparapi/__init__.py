...
_default_config = {
    'KEY': '4e96d504bb1e49ec848eaa146db98e84',
    'SECRET': 'c20c51a9c58541a99747bc2a753c504a',
...
class Sparapi(object):
    ...
    def init_app(self, app):
        ...
        with app.app_context():
            ...
            def per_request_callbacks():
                """Part of FLASK SNIPPETS 53

                http://flask.pocoo.org/snippets/53/
                Allows to call function only after a
                specific request and not all.
                """
                for f in getattr(flask.g, 'sparapi_call_before_request', ()):
                    f()
    ...
    def secure(self, func):
        ...
        def decorated(*args, **kwargs):
            ...
            message = request.headers.get(
                utils.config_value('HEADER_SIGNED'), None)
            if message is None:
                abort(417)
